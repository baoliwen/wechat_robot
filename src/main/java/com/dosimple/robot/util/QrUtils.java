...
public class QrUtils {
    ...
    public static byte[] genQr(BitMatrix bitMatrix) {
        if (null == bitMatrix) {
            return null;
        }
        ...
        byte[] byteArray = null;
        try {
            ImageIO.write(bufferedImage,"png",out);//png 为要保存的图片格式
     ...
     */
    public static void genQR(String codeContent, File codeImgFileSaveDir, String fileName) {
        try {
            /** 参数检验*/
